 ...
 */
package zoom.view.flow.libs;

import java.util.ArrayList;
import java.util.LinkedList;

import zoom.view.flow.R;
import zoom.view.flow.utils.AppFlags;
 ...
 * 
 */
public class ViewFlow extends AdapterView<Adapter> implements AnimationListener{
	...
	public void initialize(Context context, Object arrowStack, int position, int lastposition){
...
//					"ViewFlow can only be used in EXACTLY mode.");
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
	  ...
	  if( ev.getPointerCount() > 1 || ZoomFlags.isZoomed() || AppFlags.isEventBanned() )
	    return false;
	...
	public boolean onTouchEvent(MotionEvent ev) {
	  ...
	  if( ev.getPointerCount() > 1 || ZoomFlags.isZoomed() )
	    return false;
